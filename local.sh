...
grep -rl "o.dp:3000" ./www | xargs sed -i '' 's/o.dp:3000/192.168.31.34:8000/g'
...
scp ./platforms/android/ant-build/MainActivity-debug.apk xyh@guluabc.com:/home/xyh/app-getter/public/kf-local.apk
exit
